...
<div class="container-xxl container-p-y">
    ...
    <div class="card mb-4" id="addThisFormContainer">
        <h5 class="card-header">Add new credit voucher</h5>
        <div class="row">
          <div class="ermsg"></div>
        </div>
        <form class="card-body" id="createThisForm">
            ...
            <div class="row g-3">
              <div class="col-md-6">
                ...
                <input type="text" id="voucher_type" class="form-control" name="voucher_type" value="Credit" readonly />
            ...
            <div class="row g-3">
              <div class="col-md-6">
                <label class="form-label" for="transaction_method_id">Debit Account Head</label>
        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">All Credit Voucher</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
